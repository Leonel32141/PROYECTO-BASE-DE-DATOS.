...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-06-2026 a las 21:05:09
...
CREATE TABLE IF NOT EXISTS `clubes` (
  `id_club` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `competiciones` (
  `id_competicion` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `jugadores` (
  `id_jugador` int(11) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura Stand-in para la vista `mejores_jugadores_del_torneo`
-- (Véase abajo para la vista actual)
--
DROP VIEW IF EXISTS `mejores_jugadores_del_torneo`;
CREATE TABLE IF NOT EXISTS `mejores_jugadores_del_torneo` (
`nombre` varchar(20)
,`apellido` varchar(20)
,`nombre_club` varchar(40)
,`rendimiento_total` bigint(12) unsigned
);
...
CREATE TABLE IF NOT EXISTS `partidos` (
  ...
  KEY `partidosA` (`id_clubLocal`),
  KEY `partidosB` (`id_clubVisitante`),
  KEY `partidosC` (`id_competicion`)
...
CREATE TABLE IF NOT EXISTS `rankings` (
  `id_ranking` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
-- Estructura para la vista de `mejores_jugadores_del_torneo` exportada como una tabla
--
...
CREATE TABLE IF NOT EXISTS `mejores_jugadores_del_torneo`(
    ...
    `nombre_club` varchar(40) COLLATE utf8mb4_general_ci NOT NULL,
    `rendimiento_total` bigint(12) unsigned NOT NULL DEFAULT '0'
);
