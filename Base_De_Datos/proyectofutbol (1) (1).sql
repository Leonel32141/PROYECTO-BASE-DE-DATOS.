...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-04-2026 a las 23:15:00
...
(50, 10, 'Dylan', 'Aquino', 19, 'Argentina', 11, 11, 8),
...
(60, 12, 'Jonathan', 'Herrera', 34, 'Argentina', 9, 8, 1),
...
(70, 14, 'Genaro', 'Rossi', 23, 'Argentina', 9, 6, 1),
...
(99, 20, 'Federico', 'Bisanz', 24, 'Argentina', 10, 5, 7),
...
--
ALTER TABLE `partidos`
  MODIFY `id_partido` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=89;
